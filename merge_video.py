...
p1 = 'D:\\9\\video_test\\' + videoid
os.system('mkdir ' + p1)
score_path = 'D:\\9\\video_test\\' + videoid + '\\' + v1[0] + '\\' + v1[1] + '\\' + v1[2] + '\\score'
os.system('mkdir ' + score_path)
route_path = 'D:\\9\\video_test\\' + videoid + '\\' + v1[0] + '\\' + v1[1] + '\\' + v1[2] + '\\route'
os.system('mkdir ' + route_path)
win_lost_path = 'D:\\9\\video_test\\' + videoid + '\\' + v1[0] + '\\' + v1[1] + '\\' + v1[2] + '\\win_lost'
...
upload = 'aws s3 cp ' + 'D:\\9\\video_test\\' + videoid + ' s3://cba.hbang.com.cn --recursive'
os.system(upload)
